...
class VoronoiGraphGenerator:
    def __init__(self, cluster: str, env_name: str, floor: int):
        ...
        try:
            self._map = cv2.imread(os.path.join(os.path.dirname('C:/Users/User/Desktop/uni/Tesi/neural-astar/src/neural_astar/utils/voronoi_utilities/'), 'maps_data', 'maps', cluster, env_name + '_floor_' + str(floor) + '.png'))
            with open(os.path.join(os.path.dirname('C:/Users/User/Desktop/uni/Tesi/neural-astar/src/neural_astar/utils/voronoi_utilities/'), 'maps_data', 'maps_metadata', env_name + '_floor_' + str(floor)) + '.yaml', mode='r') as f:
    ...
    def generate_voronoi_bitmap(self, save_to_file: bool = False) -> np.array:
        ...
        if save_to_file:
            ...
            cv2.imwrite(os.path.join(
                os.path.dirname('C:/Users/User/Desktop/uni/Tesi/neural-astar/src/neural_astar/utils/voronoi_utilities/'), 'maps_data', 'voronoi_bitmaps',
            ...
            cv2.imwrite(os.path.join(
                os.path.dirname('C:/Users/User/Desktop/uni/Tesi/neural-astar/src/neural_astar/utils/voronoi_utilities/'), 'maps_data', 'maps_with_voronoi_bitmaps',
                self._env_name + '_floor_' +  str(self._floor) + '.png'),
                map_voronoi_bitmap)
